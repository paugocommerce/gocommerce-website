...
const DesktopFunFactsArea = () => {
    return (
       <div className="funfacts-area ptb-80">
            <div className="container">
                <div className="section-title">
                    <h2 className='gocom-framework'>We drive <span className='highlight'>Results,</span>Not just <span className='highlight'>Potential</span></h2>
               
                    
                    <p className='gocom-framework-desc'>Our proven frameworks have helped brands become market leaders online.</p>
                </div>
...
export default DesktopFunFactsArea;